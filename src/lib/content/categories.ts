...
> = {
  Company: {
    ...
    resultTemplates: [
      "출근 압박에서 {time}초 버텼다",
      "결재 지옥을 {distance}m 손절했다",
      "야근 {coins}개를 피해 줄행랑",
      "부장님 호출을 {near}번 못 본 척했다",
      "{distance}m 도망쳐도 내일 또 출근… 현타 제대로",
      "정시 퇴근의 꿈, {time}초 만에 증발",
      "업무 카톡 {coins}개 읽씹하고 튀었다",
      "{score}점어치 월급루팡 성공",
      "월요병 {distance}m 따돌렸다, 럭키비키🍀",
      "성과급은 행복회로 속에만, 몸은 {distance}m 폼 미쳤다",
    ],
  ...
  School: {
    ...
    resultTemplates: [
      ...
      "출석체크 직전 {time}초간 잠수",
      "{score}점인데 이게 시험 점수면 갓생일 텐데",
      "공부 감은 죽었어도 도망 폼은 미쳤다",
      "야자 째고 {distance}m 직진, 럭키비키🍀",
  ...
  Romance: {
    ...
    resultTemplates: [
      ...
      "미련 {coins}스푼 손절하고 {distance}m 질주",
      "새벽 감성 톡, {time}초 만에 참아냈다",
      "썸은 끝났어도 {distance}m는 영원하다",
      "솔로 탈출은 실패, 도망 폼은 {score}점",
      "어장에서 탈출해 {distance}m 달렸다",
  ...
  Military: {
    ...
    introTemplates: [
      ...
      "부소대장의 호각이 들린다",
      "남은 군 생활이 추격해온다",
      "전역일은 멀고 점호는 코앞, 존버 모드",
      "'아직도 상병?' 현타가 몰려온다",
    ],
    resultTemplates: [
      "훈련에서 {time}초 버텼다",
      "행군 {distance}m 완주, 중꺽마",
      "PX 간식 {coins}개 확보",
      "점호를 {near}번 아슬하게 피했다",
  ...
  Family: {
    ...
    resultTemplates: [
      ...
      "잔소리는 얄미워도 엄마는 동결건조각, {distance}m 질주",
      "비교당하기 싫어 {score}점만큼 더 달렸다",
    ],
    emotionFallback: "Tired",
  },
  Reality: {
