...
> = {
  ...
  School: {
    ...
    resultTemplates: [
      ...
      "학점은 꺾여도 도망갈 마음은 안 꺾인다",
      "야자 째고 {distance}m 직진, 갓생은 실패",
      "조별과제 무임승차 {near}번 모른 척하며 질주",
    ],
  ...
  Romance: {
    ...
    introTemplates: [
      ...
      "삼귀던 그 사람이 잠수탔다",
      "'우리 무슨 사이야'가 추격해온다",
      "읽씹과 답장 사이, 새벽 감성이 몰려온다",
    ],
    resultTemplates: [
      "이별에서 {time}초 버텼다",
      "연애 세포는 죽어도 도망 세포는 {distance}m 팔팔하다",
      "{coins}개의 읽씹 알림을 피했다",
  ...
  Military: {
    ...
    resultTemplates: [
      ...
      "건빵 {coins}봉지 사수",
      "{score}점이면 포상휴가 주나요",
      "말년 갓생은 포기, 그래도 {distance}m는 뛰었다",
      "전역까지 카운트다운, 오늘은 {distance}m 직진",
    ],
  ...
  Reality: {
    ...
    introTemplates: [
      ...
      "번아웃이 스멀스멀 다가온다",
      "현생이 코앞까지 왔다",
      "{input}... 할 일 목록이 끝없이 따라온다",
      "오늘도 갓생은 내일로 미뤘다",
    ],
    resultTemplates: [
      "현실에서 {time}초 버텼다",
      "{distance}m 도망 성공",
      "통장 잔고 확인하고 {coins}개 더 걱정했다",
